<x-app-layout>
    ...
    <div class="w-full min-h-fit grid place-items-center bg-white pb-5">
        ...
        <div class="flex py-5 space-x-3">
            <a class="px-6 py-2 rounded shadow border text-black border-emerald-600 hover:bg-emerald-500 hover:text-white transition-colors" href="{{ route('home') }}">Torna alla Home</a>
            <a class="px-6 py-2 rounded shadow border text-black border-emerald-600 hover:bg-emerald-500 hover:text-white transition-colors" href="{{ route('orders.index') }}">Vai ai tuoi Ordini</a>
        </div>
    </div>
</x-app-layout>