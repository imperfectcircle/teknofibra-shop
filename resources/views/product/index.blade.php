...
<x-app-layout>
  ...
  <!--/ Search & Sort -->
    ...
    <h1 class="my-10 text-center text-3xl font-semibold">Scopri le Soluzioni Isolanti di Teknofibra: <br> Acquista Ora i Migliori Prodotti per l'Automotive e l'Aviazione!</h1>
