<template>
    <div
        class="w-[200px] transition-all bg-indigo-600 text-gray-100 py-8 pl-4 pr-2 space-y-2 rounded-l-2xl"
    >
        <router-link
        ...
        >
            <span class="mr-2">
                <GlobeEuropeAfricaIcon class="w-6" />
            </span>
            <span> Gestione Paesi </span>
        </router-link>
        <router-link
