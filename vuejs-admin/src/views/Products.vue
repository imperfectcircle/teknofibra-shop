    ...
    <div class="bg-white p-4 rounded-lg shadow">
        ...
        <template v-else>
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        ...
                        <th class="border-b-2 p-2 text-left">Immagine</th>
                        <th class="border-b-2 p-2 text-left">Titolo</th>
                        <th class="border-b-2 p-2 text-left">Prezzo</th>
                        <th class="border-b-2 p-2 text-left">Aggiornato Al</th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="flex justify-between items-center mt-5">
                <span>Prodotti da {{ products.from }} a {{ products.to }}</span>
                <nav
